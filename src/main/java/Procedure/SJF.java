...
public class SJF extends ProcedureMethod {
    public SJF() throws IOException {
        super();
    }

    @Override
    public String getOrder() {
        PriorityQueue<Process> processPriorityQueue = new PriorityQueue<>(Comparator.comparingInt(Process::getBurstTime));
