...
public class STRF extends ProcedureMethod {
    ...
    public String getOrder() {
        PriorityQueue<Process> processPriorityQueue = new PriorityQueue<>(Comparator.comparingInt(Process::getLeftExecuteTime));
